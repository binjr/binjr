_[New]_ Added a new, alternative indexing method for log file that allows for fast partial matching of terms, without the need for wildcards/fuzzy operators.
