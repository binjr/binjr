...
public class CannotInitializeDataAdapterException extends DataAdapterException {
     ...
     */
    public CannotInitializeDataAdapterException(String message) {
        super(message);
    }
     ...
     */
    public CannotInitializeDataAdapterException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause the cause for the exception.
     */
    public CannotInitializeDataAdapterException(Throwable cause) {
        super(cause);
    }
}
