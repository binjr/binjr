 ...
 */
public class ScatterChartWorksheetController extends WorksheetController {

    /**
     * Initializes a new instance of the {@link ScatterChartWorksheetController} class
     *
     * @param worksheet the {@link Worksheet} instance associated to the controller
     */
    public ScatterChartWorksheetController(Worksheet worksheet) throws IOException {
        super(worksheet);
    }
