...
public class LogParserParameters {
    private static final Logger logger = Logger.create(LogParserParameters.class);
    ...
    public LogParserParameters(String timestampPattern, String payloadPattern, String timeFormatPattern, ZoneId zoneId){
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("LogParserParameters{");
