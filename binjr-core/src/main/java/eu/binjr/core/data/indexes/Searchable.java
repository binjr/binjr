...
public interface Searchable extends Closeable {
    void add(String path, InputStream ias, ParserParameters parser) throws IOException;

    void add(String path, InputStream ias, boolean commit, ParserParameters parser) throws IOException;
