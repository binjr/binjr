...
public interface Searchable extends Closeable {
    void add(String path, InputStream ias, EventParser parser) throws IOException;

    void add(String path, InputStream ias, boolean commit, EventParser parser) throws IOException;
