...
* _As a JAR_
  ...
  All dependencies are packaged inside the executable jar; to start the application simply run `java -jar binjr.jar` (or double-click the jar file, provided your environment is configured adequately).
