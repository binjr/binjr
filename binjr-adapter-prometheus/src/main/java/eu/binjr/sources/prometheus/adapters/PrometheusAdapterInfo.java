...
/**
 * Defines the metadata associated with the PrometheusDataAdapter
 *
...
@AdapterMetadata(
        ...
        adapterClass = PrometheusAdapter.class,
        dialogClass = PrometheusAdapterDialog.class,
        preferencesClass = PrometheusAdapterPreferences.class,
        sourceLocality = SourceLocality.REMOTE,
        apiLevel = AppEnvironment.PLUGIN_API_LEVEL
)
public class PrometheusAdapterInfo extends BaseDataAdapterInfo {

    /**
     * Initialises a new instance of the {@link PrometheusAdapterInfo} class.
     *
     * @throws CannotInitializeDataAdapterException if an error occurs initializing the adapter.
     */
    public PrometheusAdapterInfo() throws CannotInitializeDataAdapterException {
        super(PrometheusAdapterInfo.class);
    }
}
