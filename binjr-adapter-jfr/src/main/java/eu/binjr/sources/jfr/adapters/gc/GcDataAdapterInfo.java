...
@AdapterMetadata(
        ...
        adapterClass = GcDataAdapter.class,
...
public class GcDataAdapterInfo extends BaseDataAdapterInfo {

    /**
     * Initialises a new instance of the {@link GcDataAdapterInfo} class.
     *
     * @throws CannotInitializeDataAdapterException if the adapter's initialization failed
     */
    public GcDataAdapterInfo() throws CannotInitializeDataAdapterException {
        super(GcDataAdapterInfo.class);
    }
