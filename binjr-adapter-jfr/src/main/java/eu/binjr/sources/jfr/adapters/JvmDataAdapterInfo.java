...
@AdapterMetadata(
        name = "JFR",
        description = "JDK Flight Recorder Data Adapter",
        copyright = AppEnvironment.COPYRIGHT_NOTICE,
        license = AppEnvironment.LICENSE,
        siteUrl = AppEnvironment.HTTP_WWW_BINJR_EU,
        adapterClass = JvmDataAdapter.class,
        dialogClass = JvmDataAdapterDialog.class,
        sourceLocality = SourceLocality.LOCAL,
        apiLevel = AppEnvironment.PLUGIN_API_LEVEL,
        visualizationType = VisualizationType.FLAME_GRAPHS
)
public class JvmDataAdapterInfo extends BaseDataAdapterInfo {

    /**
     * Initialises a new instance of the {@link JvmDataAdapterInfo} class.
     *
     * @throws CannotInitializeDataAdapterException if the adapter's initialization failed
     */
    public JvmDataAdapterInfo() throws CannotInitializeDataAdapterException {
        super(JvmDataAdapterInfo.class);
    }
